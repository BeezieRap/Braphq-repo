...
// --- Marketplace contract address (replace with your actual address) ---
  ...
  return (
    <div style={pageStyle}>
      {!account ? (
        ...
        <>
          <h1 style={{ color: "#111" }}>
            Jeet Your Bumba Beez den prick!
          </h1>
          {loading ? (
            ...
            <p style={{ color: "#111" }}>
              You aint got no Bumba Beez fam what are you
              on?
            </p>
          ) : (
            <div
